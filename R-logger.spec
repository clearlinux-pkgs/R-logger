...
Version  : 0.2.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/logger_0.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/logger_0.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623693729
